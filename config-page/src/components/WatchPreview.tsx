...
export const WatchPreview: React.FC = () => {
      ...
      <div className="pebble-watch-face">
        ...
        >
          <path
            ...
            fill={getHex(settings.SETTING_RING_NIGHT_COLOR)}
            d="M0 86h144v82H0z"
          />
          <path
            id="SETTING_RING_DAY_COLOR"
            fill={getHex(settings.SETTING_RING_DAY_COLOR)}
            d="M0 0h144v82H0z"
          />
          <path
            id="SETTING_SUN_FILL_COLOR"
            fill={getHex(settings.SETTING_SUN_FILL_COLOR)}
            d="M52 8.5a8.5 8.5 0 1 1-17 0 8.5 8.5 0 0 1 17 0Z"
          />
          <path
            id="SETTING_SUN_STROKE_COLOR"
            fill={getHex(settings.SETTING_SUN_STROKE_COLOR)}
            fillRule="evenodd"
          ...
          <path
            ...
            fill={getHex(settings.SETTING_RING_SUNRISE_COLOR)}
            d="M19 72v25H0V72h19Z"
          />
          <path
            id="SETTING_RING_SUNSET_COLOR"
            fill={getHex(settings.SETTING_RING_SUNSET_COLOR)}
            d="M144 72v25h-19V72h19Z"
          />
          <path
            id="SETTING_BG_COLOR"
            fill={getHex(settings.SETTING_BG_COLOR)}
            d="M16 16h112v136H16z"
          />
          <path
            id="SETTING_PIP_COLOR_SECONDARY"
            fill={getHex(settings.SETTING_PIP_COLOR_SECONDARY)}
          ...
          <path
            ...
            fill={getHex(settings.SETTING_PIP_COLOR_PRIMARY)}
            d="M17 83h6v3h-6v-3ZM70 23v-5h3v5h-3ZM70 151v-6h3v6h-3ZM121 83h6v3h-6v-3Z"
          />
          <g id="SETTING_RING_STROKE_COLOR" fill={getHex(settings.SETTING_RING_STROKE_COLOR)} fillRule="evenodd" clipRule="evenodd">
        ...
        <div className="pebble-watch-preview-content">
          <div className="pebble-watch-preview-widget secondary upper" style={{ color: getHex(settings.SETTING_SUBTEXT_SECONDARY_COLOR) }}>
            Upper Text 1
          </div>
          <div className="pebble-watch-preview-widget primary upper" style={{ color: getHex(settings.SETTING_SUBTEXT_PRIMARY_COLOR) }}>
            2000 Steps
          </div>
          <div className="pebble-watch-time" style={{ color: getHex(settings.SETTING_TIME_COLOR) }}>
          ...
          <div className="pebble-watch-preview-widget primary lower" style={{ color: getHex(settings.SETTING_SUBTEXT_PRIMARY_COLOR) }}>
            Mon, Jan 01
          </div>
          <div className="pebble-watch-preview-widget secondary lower" style={{ color: getHex(settings.SETTING_SUBTEXT_SECONDARY_COLOR) }}>
            Lower Text 2
          </div>
        </div>
      </div>
