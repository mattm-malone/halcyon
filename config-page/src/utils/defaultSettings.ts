...
export const getDefaultSettings = (capabilities: Capabilities): Settings => ({
  ...
  SETTING_NIGHT_TIME_COLOR: capabilities.BW ? '000000' : 'FFFFFF',
  SETTING_NIGHT_SUBTEXT_PRIMARY_COLOR: capabilities.BW ? '000000' : 'FFFFFF',
  SETTING_NIGHT_SUBTEXT_SECONDARY_COLOR: capabilities.BW ? '000000' : 'AAAAFF',
  SETTING_NIGHT_BG_COLOR: capabilities.BW ? 'FFFFFF' : '000055',
  SETTING_NIGHT_PIP_COLOR_PRIMARY: capabilities.BW ? '000000' : 'FFFFFF',
  SETTING_NIGHT_PIP_COLOR_SECONDARY: capabilities.BW ? '000000' : '0055AA',
