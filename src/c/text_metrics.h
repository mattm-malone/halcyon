...
// Widget slot fonts: primary = current date size, secondary = one step smaller
#define FONT_WIDGET_PRIMARY FONT_KEY_GOTHIC_24_BOLD
#define FONT_WIDGET_PRIMARY_HEIGHT METRIC_GOTHIC_24_BOLD_HEIGHT
#define FONT_WIDGET_PRIMARY_OFFSET METRIC_GOTHIC_24_BOLD_OFFSET
...
#define FONT_WIDGET_PRIMARY_HEIGHT METRIC_GOTHIC_18_BOLD_HEIGHT
#define FONT_WIDGET_PRIMARY_OFFSET METRIC_GOTHIC_18_BOLD_OFFSET
